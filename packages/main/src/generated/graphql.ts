...
import { Account as AccountType, AccountMutations as AccountMutationsType, ConversationMutations as ConversationMutationsType, Message as MessageType } from '../resolvers/types';
...
export type ResolversTypes = {
  ...
  ConversationSearchResult: ResolverTypeWrapper<Omit<ConversationSearchResult, 'conversation'> & { conversation: ResolversTypes['Conversation'] }>,
...
export type ResolversParentTypes = {
  ...
  Search: SearchType,
  Int: Scalars['Int'],
  ConversationSearchResult: Omit<ConversationSearchResult, 'conversation'> & { conversation: ResolversParentTypes['Conversation'] },
  Mutation: {},
...
export type AccountResolvers<ContextType = any, ParentType extends ResolversParentTypes['Account'] = ResolversParentTypes['Account']> = {
  ...
  conversations?: Resolver<Array<ResolversTypes['Conversation']>, ParentType, ContextType, AccountConversationsArgs>,
  messages?: Resolver<Array<ResolversTypes['Message']>, ParentType, ContextType>,
  search?: Resolver<ResolversTypes['Search'], ParentType, ContextType, RequireFields<AccountSearchArgs, 'query'>>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type AccountMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['AccountMutations'] = ResolversParentTypes['AccountMutations']> = {
  create?: Resolver<ResolversTypes['Account'], ParentType, ContextType, RequireFields<AccountMutationsCreateArgs, 'email'>>,
  authenticate?: Resolver<ResolversTypes['Account'], ParentType, ContextType, RequireFields<AccountMutationsAuthenticateArgs, 'id'>>,
  delete?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<AccountMutationsDeleteArgs, 'id'>>,
  sync?: Resolver<ResolversTypes['Account'], ParentType, ContextType, RequireFields<AccountMutationsSyncArgs, 'id'>>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};
...
export type ConversationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Conversation'] = ResolversParentTypes['Conversation']> = {
  ...
  presentableElements?: Resolver<Array<ResolversTypes['Presentable']>, ParentType, ContextType>,
  isRead?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>,
  isStarred?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>,
  replyRecipients?: Resolver<ResolversTypes['Participants'], ParentType, ContextType, RequireFields<ConversationReplyRecipientsArgs, 'fromAccountId'>>,
  snippet?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  subject?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ConversationMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationMutations'] = ResolversParentTypes['ConversationMutations']> = {
  archive?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<ConversationMutationsArchiveArgs, 'id'>>,
  flag?: Resolver<Array<ResolversTypes['Conversation']>, ParentType, ContextType, RequireFields<ConversationMutationsFlagArgs, 'ids' | 'isFlagged'>>,
  flagPresentable?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<ConversationMutationsFlagPresentableArgs, 'id' | 'conversationId' | 'isFlagged'>>,
  edit?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<ConversationMutationsEditArgs, 'accountId' | 'conversationId' | 'resource' | 'revision' | 'content'>>,
  reply?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<ConversationMutationsReplyArgs, 'accountId' | 'id' | 'content'>>,
  setIsRead?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<ConversationMutationsSetIsReadArgs, 'id' | 'isRead'>>,
  sendMessage?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<ConversationMutationsSendMessageArgs, 'accountId' | 'message'>>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ConversationSearchResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationSearchResult'] = ResolversParentTypes['ConversationSearchResult']> = {
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  accounts?: Resolver<ResolversTypes['AccountMutations'], ParentType, ContextType>,
  conversations?: Resolver<ResolversTypes['ConversationMutations'], ParentType, ContextType>,
};
...
export type ParticipantsResolvers<ContextType = any, ParentType extends ResolversParentTypes['Participants'] = ResolversParentTypes['Participants']> = {
  from?: Resolver<Maybe<Array<ResolversTypes['Address']>>, ParentType, ContextType>,
  ...
  replyTo?: Resolver<Maybe<Array<ResolversTypes['Address']>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type PartSpecResolvers<ContextType = any, ParentType extends ResolversParentTypes['PartSpec'] = ResolversParentTypes['PartSpec']> = {
...
export type PresentableResolvers<ContextType = any, ParentType extends ResolversParentTypes['Presentable'] = ResolversParentTypes['Presentable']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
  isRead?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>,
  isStarred?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>,
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  addresses?: Resolver<Array<ResolversTypes['Address']>, ParentType, ContextType, RequireFields<QueryAddressesArgs, 'inputValue'>>,
  conversation?: Resolver<Maybe<ResolversTypes['Conversation']>, ParentType, ContextType, RequireFields<QueryConversationArgs, 'id'>>,
  conversations?: Resolver<Array<ResolversTypes['ConversationSearchResult']>, ParentType, ContextType, RequireFields<QueryConversationsArgs, 'query'>>,
};
